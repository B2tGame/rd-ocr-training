#!/bin/bash
/env/bin/python -m trdg.run -c $NUM_IMG -rs -num -na 3 -e $IMG_FMT -r -w 5 -im 1 --output_dir /app/code/tesstrain/data/new_model-ground-truth -fd /app/code/trdg/trdg/fonts/custom/
